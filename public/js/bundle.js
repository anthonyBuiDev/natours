...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYm5hbWxpa2VoZXJvIiwiYSI6ImNsZGl2OWo3NzBiNXIzb213dDJuNXk4aTkifQ.2pSrEyTDGihyHILQPerLAg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/bnamlikehero/cldiw5epj000101t9uyieowwv',
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Sign up successfully! Please log in');
            window.setTimeout(function () {
...
function () {
  ...
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee5(password, passwordConfirm) {
    var res;
...
var stripe = Stripe('pk_test_51MXnA9LcBIocWUCznkPZL9S8ksm4lJKhpnsjct3wKBvfWeaD6DJAiTgXUZBybJQMNhD9DF7gLNnocql7S4dvzuaW00kMrM7b83');
...
var resetPasswordForm = document.querySelector('.form--resetPassword'); // DELEGATION
...
if (forgotPasswordForm) forgotPasswordForm.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
...
if (resetPasswordForm) resetPasswordForm.addEventListener('submit',
/*#__PURE__*/
function () {
  var _ref3 = _asyncToGenerator(
  /*#__PURE__*/
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          passwordConfirm = document.getElementById('password-confirm').value;
          _context3.next = 5;
          return (0, _auth.resetPassword)(password, passwordConfirm);
